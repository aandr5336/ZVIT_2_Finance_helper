...
def open_settings_dialog(page):
    ...
    dlg = ft.AlertDialog(
        ...
        shadow_color=ft.Colors.with_opacity(0, ft.Colors.BLACK),
...
def open_left_menu_dialog(page, go_home, go_control_panel, go_transactions, go_budget, go_goals, go_reports, go_categories, go_settings):
